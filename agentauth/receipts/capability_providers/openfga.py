...
'clayseal-receipts[openfga] @ git+https://github.com/clayseal/clayseal-receipts.git@v0.5.2'``.
Configuration via ``context`` or environment:
    ...
    def _check(
        ...
        try:
            ...
            raise ImportError(
                ...
                "pip install 'clayseal-receipts[openfga] @ "
                "git+https://github.com/clayseal/clayseal-receipts.git@v0.5.2'"
            ) from exc
